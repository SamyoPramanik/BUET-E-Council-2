...
export default function ViewerMeetingsPage() {
  const { user } = useAuth();
  ...
  // Fetch real data
  const { data: response, isLoading } = useSWR('/meetings', fetcher);

  const allMeetings = response?.data || [];
  
  // Filter by type, hiding drafts from the viewer dashboard
