...
CREATE TABLE meetings (
    ...
    permissions_locked_level INTEGER DEFAULT NULL,
    permissions_locked_by_username VARCHAR(255) DEFAULT NULL,
    permissions_locked_by_role VARCHAR(255) DEFAULT NULL,
    description_locked_level INTEGER DEFAULT NULL,
    description_locked_by_username VARCHAR(255) DEFAULT NULL,
    description_locked_by_role VARCHAR(255) DEFAULT NULL,
    ...
    email_locked_level INTEGER DEFAULT NULL,
    email_locked_by_username VARCHAR(255) DEFAULT NULL,
    email_locked_by_role VARCHAR(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS notices (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    meeting_id UUID REFERENCES meetings (id) ON DELETE CASCADE,
    notice_number VARCHAR(255) DEFAULT '',
    notice_date TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    notice_type VARCHAR(50) NOT NULL CHECK (notice_type IN ('invitation', 'agenda', 'resolution')),
    body TEXT DEFAULT '',
